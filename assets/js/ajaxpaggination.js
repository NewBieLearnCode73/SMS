        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(students, function (index, student) {
                    html += "<tr>";
                    html +=
                        "<td><h2><a href='admin/admin-student-profile.php?id=" +
                        student.id +
                        "' class='avatar text-white'><img src='" +
                        student.image +
                        "' alt='' /></a><a href='admin/admin-student-profile.php?id=" +
                        student.id +
                        "'>" +
                        student.name +
                        "</a></h2></td>";
